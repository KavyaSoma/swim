...
<!-- model popup ends here -->
 ...
 <li class="breadcrumb-item"><a style="color:#777;" href="{{url('addevent/'.$event_id)}}">Add Event</a></li>
  ...
  <li class="breadcrumb-item">Event Time</li>
...
<div>
  ...
  <a href="{{url('subevent/'.$event_id)}}" class="btn btn-primary mybtn">Back</a>
  <button class="btn btn-primary mybtn">Save</button>
  @if(count($event_time)>0)
  <a href="{{url('/contact-event/'.$event_id)}}" class="btn btn-primary mybtn" type="reset">Next</a>
  @else
  <a href="{{url('/contact-event/'.$event_id)}}" class="btn btn-primary mybtn disabled" type="reset">Next</a>
  @endif
         </div></form></div>
<br>
    </div>
