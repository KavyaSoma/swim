                 ...
                 <li class="active">
                  ...
                  <div class="tab-content tab_details">
                    ...
                    <div class="tab-pane fade in active" id="stagesummary">
                      ...
                      <form class="form-horizontal" style="background:#fff;" method="post" action="{{url('finalheatsetup/'.$event_id)}}">
                        {{csrf_field()}}
...
console.log('{{ url('oldfinalheat/'.$event_id) }}');
$.ajax({
    url: '{{ url('oldfinalheat/'.$event_id)  }}',
