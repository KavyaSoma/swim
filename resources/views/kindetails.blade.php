...
@endif
<a href="{{url('editprofile')}}"><button class="btn btn-primary mybtn">Edit</button></a>
   @if(Session::get('user_type') == "user")
  <a href="{{url('addkin')}}" class="btn btn-primary mybtn">Add Kin </a>
...
<form class="form-horizontal kin_info">
       ...
       <div class="well" style="background:#fff">
         ...
         <div class="row" style="width:73%">
           ...
           <li class="active"><a href="{{url('kindetails')}}"> <i class="fa fa-cog" aria-hidden="true" id="info_fa"></i> Kin details</a></li>
