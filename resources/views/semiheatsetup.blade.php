                 ...
                 <li>
                  ...
                  <div class="tab-content tab_details">
                    ...
                    <div class="tab-pane fade in active" id="stagesummary">
                      ...
                      <form class="form-horizontal" style="background:#fff;" method="post" action="{{url('semiheatsetup/'.$event_id)}}">
                        {{csrf_field()}}
...
console.log('{{ url('oldsemifinal/'.$event_id) }}');
$.ajax({
    url: '{{ url('oldsemifinal/'.$event_id)  }}',
