...
<!-- model popup ends here -->
 ...
 <ol class="breadcrumb" style="border:1px solid #46A6EA;color:#46A6EA;">
  ...
  <li class="breadcrumb-item">Event Venue</li>
  </ol>
  ...
  <li ><a data-toggle="tab" class="" href="#mhome">Basic Details</a></li>
    ...
    @if(count($venue_details)>0)
    <li><button class="btn btn-warning pull-right" data-toggle="modal" data-target="#myModalh"><i class="fa fa-bars"></i> Previous Entries</button>
 </li>
 @endif
  </ul>
    </div>
...
<a href="{{url('/schedule-event/'.$event_id)}}" class="btn btn-primary mybtn">Back</a>
